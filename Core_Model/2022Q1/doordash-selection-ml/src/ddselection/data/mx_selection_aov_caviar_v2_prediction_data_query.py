...
query_nn_pred_features_aov_v2 = query_head + review_ratings_sales_query + cat_pool_query + \
F"""
    SELECT 
          nnf.*
...
query_ac_pred_features_aov_v2 = query_head + review_ratings_sales_query + cat_pool_query + \
F"""
    SELECT 
          danpf.*
...
query_da_pred_features_aov_v2 = query_head + review_ratings_sales_query + cat_pool_query + \
F"""
    SELECT 
          danpf.*
        , danpsf.avg_search_count_84_days_before_null_excluded
