...
q_aov_training_data_ac_v2 = search_feature_query_danp + review_ratings_sales_query + cat_pool_query +\
F"""
SELECT
      td.*
    , td.reactivation_timestamp as activation_date
    , b.subtotal_per_order
...
q_aov_training_data_nn_v2 = search_feature_query_nn + review_ratings_sales_query + cat_pool_query +\
F"""
SELECT
      nn.*
...
q_aov_training_data_da_v2 = search_feature_query_danp + review_ratings_sales_query + cat_pool_query +\
F"""
SELECT
      td.*
    , td.reactivation_timestamp as activation_date
